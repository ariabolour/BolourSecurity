...
struct CertificateParsingTests {
    ...
    func leaf() throws {
        ...
        #expect(leaf.subject.commonName == "valid.blursecurity.test")
        #expect(leaf.isCertificateAuthority == false)
        #expect(leaf.subjectAlternativeNames.contains(.dnsName("valid.blursecurity.test")))
    ...
    func root() throws {
        ...
        #expect(root.subject.commonName == "BlurSecurity Test Root")
        #expect(root.subject.organizationName == "BlurSecurity")
    }
