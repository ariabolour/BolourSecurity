...
public enum StorageError: SecurityError {
    ...
    /// A lower-layer failure (Foundation file I/O, `BlurKeychain`, `BlurCrypto`) that doesn't map
    ...
    public var recoverySuggestion: String? {
        switch self {
        case .vaultLocked:
            return "Authenticate with BlurBiometrics and pass the resulting context to Vault.open(context:)."
        case .pathNotFound:
