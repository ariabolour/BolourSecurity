...
/// across `BolourKeychain`/`BolourCrypto` operations rather than triggering a second biometric
...
public struct AuthenticatedContext: Sendable, PresenceAuthenticated {
    ...
    /// Ends the session early. `BolourKeychain`/`BolourCrypto` calls made with this context after
