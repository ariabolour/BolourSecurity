...
| `BolourSecureStorage` | Beta | The vault's master key is documented as Secure Enclave-wrapped but is currently software-held in the keychain — a real gap between design and delivery. Stays Beta until that's closed and every doc agrees with the code |
